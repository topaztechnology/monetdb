FROM topaztechnology/base:3.8
MAINTAINER Topaz Tech Ltd <info@topaz.technology>

ENV MONETDB_VERSION 11.31.13
...
RUN \
  apk add --update --no-cache libatomic libxml2 readline libcrypto1.0 libressl pcre libbz2 lz4-libs \
    snappy xz-libs && \
